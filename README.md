...
- **Expression and accessory helpers** – Utility modules generate simple overlay
  graphics (eyes, brows, blush, cat ears, glasses, sparkles, etc.) on transparent
  canvases.  They are rule-based drawings—no ControlNet/SAM integration yet—but
  they produce predictable assets that can be combined in the editor.
